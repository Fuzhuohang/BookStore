        ...
        <div class="layui-side-scroll">
            ...
            <ul class="layui-nav layui-nav-tree" lay-filter="test" lay-shrink="all">
                ...
                <li class="layui-nav-item">
                    ...
                    <dl class="layui-nav-child">
                        <dd><a href="">部门信息管理</a></dd>
                        <dd><a href="">岗位信息管理</a></dd>
                    </dl>
                </li>
                ...
                <li class="layui-nav-item"><a href="">职业生涯信息维护</a></li>
                <li class="layui-nav-item"><a href="">外语能力信息维护</a></li>
                <li class="layui-nav-item"><a href="">家庭成员维护</a></li>
                ...
                <li class="layui-nav-item"><a href="">新入职员工</a></li>
                <li class="layui-nav-item"><a href="">离职员工</a></li>
                <li class="layui-nav-item"><a href="">部门调动员工</a></li>
                <li class="layui-nav-item"><a href="">岗位调动员工</a></li>
