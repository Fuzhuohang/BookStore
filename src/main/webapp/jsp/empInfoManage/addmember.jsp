        ...
        <form id="myform" class="layui-form">
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input type="text" name="employee_id" placeholder="--员工编号--" autocomplete="off" lay-verify="emp_c|required" class="layui-input">
                </div>
            </div>
            <div class="layui-form-item">
                <label class="layui-form-label">成员姓名</label>
                <div class="layui-input-block">
                    <input type="text" name="member_name" placeholder="--成员姓名--" autocomplete="off" lay-verify="name_c|required" class="layui-input">
                </div>
            </div>
            <div class="layui-form-item">
