        ...
        <form id="myform" class="layui-form " lay-filter="myform">
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input name="employee_id"  type="text" readonly="readonly" placeholder="--员工编号--" style="color:#D3D3D3" class="layui-input">
                </div>
            </div>
            <div class="layui-form-item">
                <label class="layui-form-label">外语种</label>
                <div class="layui-input-block">
                    <input name="language"  type="text" readonly="readonly" placeholder="--外语种--" style="color:#D3D3D3" class="layui-input">
                </div>
            </div>
...
<script>
    layui.use('form',function(){
        ...
        var language=GetQueryValue("language");
        var level=GetQueryValue("level");
