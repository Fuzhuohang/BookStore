    ...
    <div class="layui-body">
        <form id="myform" class="layui-form ">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input name="position" type="text" placeholder="--职位--" lay-verify="required" class="layui-input">
                </div>
            </div>
            <div class="layui-form-item">
                <label class="layui-form-label">入职时间</label>
                <div class="layui-input-block">
                    <input name="stime" id="stime" type="text" placeholder="--入职时间--" lay-verify="required" autocomplete="off" class="layui-input" >
                </div>
            </div>
            <div class="layui-form-item">
                <label class="layui-form-label">离职时间</label>
                <div class="layui-input-block">
                    <input name="ftime" id="ftime" type="text" placeholder="--离职时间--" lay-verify="required" autocomplete="off" class="layui-input" >
                </div>
            </div>
            <div class="layui-form-item">
                <label class="layui-form-label">离职原因</label>
                <div class="layui-input-block">
                    <input name="resigned_reason" type="text" placeholder="--离职原因--" lay-verify="resigned_c|required" class="layui-input">
                </div>
            </div>
            <div class="layui-form-item">
                <label class="layui-form-label">薪资</label>
                <div class="layui-input-block">
                    <input name="salary" type="text" placeholder="--薪资--" lay-verify="salary_c|required" class="layui-input">
                </div>
            </div>
            <div class="layui-form-item">
                <label class="layui-form-label">公司</label>
                <div class="layui-input-block">
                    <input name="company" type="text" placeholder="--公司--" lay-verify="company_c|required" class="layui-input">
                </div>
            </div>
            <div class="layui-form-item">
                <div class="layui-input-block">
