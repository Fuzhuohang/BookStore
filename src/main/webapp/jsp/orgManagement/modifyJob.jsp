...
<div class="layui-layout layui-layout-admin">
    ...
    <div class="layui-body">
        ...
        <script>
            document.getElementById("d").innerHTML=" 编辑此岗位的信息：";/*写入网页上方大字*/
        </script> <br>
        <form id="myform" class="layui-form " lay-filter="myform">
            <div class="layui-form-item">
                <label class="layui-form-label">岗位编号</label>
                <div class="layui-input-block">
                    <input name="job_id" id="job_id" type="text" readonly="readonly" placeholder="--岗位编号--" class="layui-input">
                </div>
            </div>
            <div class="layui-form-item">
                <label class="layui-form-label">岗位名</label>
                <div class="layui-input-block">
                    <input name="job_name" id="job_name" type="text" placeholder="--岗位名--" class="layui-input">
                </div>
            </div>
            <div class="layui-form-item">
                <label class="layui-form-label">工作内容描述</label>
                <div class="layui-input-block">
                    <input name="content" id="content" type="text" placeholder="--工作内容描述--" class="layui-input">
                </div>
            </div>
            <div class="layui-form-item">
                <label class="layui-form-label">所属部门编号</label>
                <div class="layui-input-block">
                    <input name="dept_id" id="dept_id" type="text" placeholder="--所属部门编号--" class="layui-input">
                </div>
            </div>
            <div class="layui-form-item">
                <label class="layui-form-label">月薪</label>
                <div class="layui-input-block">
                    <input name="salary" id="salary" type="text" placeholder="--月薪--" class="layui-input">
                </div>
            </div>
        </form>
...
<script>
    layui.use('form',function(){
        var form=layui.form;
        var job_id_var = GetQueryValue("job_id");
        var job_name_var=GetQueryValue("job_name");
        var content_var=GetQueryValue("content");
        var dept_id_var=GetQueryValue("dept_id");
        var salary_var=GetQueryValue("salary");
        form.render();
        form.val("myform",{
            "job_id":job_id_var,
...
<script>
    $("#btn").on("click",function(){
        ...
        //执行ajax请求
        $.ajax({
            url:"${pageContext.request.contextPath}/modifyJob.action",
            type:"POST",
            dataType:"JSON",
