...
<div class="layui-layout layui-layout-admin">
    ...
    <div class="layui-body">
        ...
        <script>
            document.getElementById("d").innerHTML=" 新建岗位信息：";/*写入网页上方大字*/
        </script> <br>
        <form id="myform" class="layui-form ">
            <div class="layui-form-item">
                <label class="layui-form-label">岗位名</label>
                <div class="layui-input-block">
                    <input name="job_name" type="text" placeholder="--岗位名--" class="layui-input">
                </div>
            </div>
            <div class="layui-form-item">
                <label class="layui-form-label">工作内容描述</label>
                <div class="layui-input-block">
                    <input name="content" type="text" placeholder="--工作内容描述--" class="layui-input">
                </div>
            </div>
            <div class="layui-form-item">
                <label class="layui-form-label">所属部门编号</label>
                <div class="layui-input-block">
                    <input name="dept_id" type="text" placeholder="--所属部门编号--" class="layui-input">
                </div>
            </div>
            <div class="layui-form-item">
                <label class="layui-form-label">月薪</label>
                <div class="layui-input-block">
                    <input name="salary" type="text" placeholder="--月薪--" class="layui-input">
                </div>
            </div>
        </form>
        <br>
        <button id="btn" class="layui-btn layui-btn-normal">提交新建岗位信息</button>
