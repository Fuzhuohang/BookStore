...
<div class="container-fluid">
    ...
    <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main" >
        ...
        <form class="layui-form" style="margin-top: 15px;" action="addproduct.action?bid=${sessionScope.current_business.bid}" method="post">
            <div class="layui-form-item">
                <label for="pname" class="layui-form-label">商品名称：</label>
                <div class="layui-input-block">
                    <input type="text" id="pname" name="pname" lay-verify="title" autocomplete="off" placeholder="请输入商品名称" class="layui-input">
                </div>
            </div>
            <div class="layui-form-item">
                <label for="price" class="layui-form-label">商品价格：</label>
                <div class="layui-input-block">
                    <input type="number" step="0.01" id="price" name="price" lay-verify="title" autocomplete="off" placeholder="请输入商品单价" class="layui-input">
                </div>
            </div>
            <div class="layui-form-item">
                <label for="pnum" class="layui-form-label">商品库存：</label>
                <div class="layui-input-block">
                    <input type="number" id="pnum" name="pnum" lay-verify="title" autocomplete="off" placeholder="请输入商品库存" class="layui-input">
                </div>
            </div>
