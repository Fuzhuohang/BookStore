            ...
            <div class="col-sm-3 col-md-2 sidebar" >
                ...
                <ul class="nav nav-sidebar">
                    <c:forEach items="${sessionScope.current_category}" var="category">
                        <li><a href="getCategorysecond.action?cateid=${category.cateId}">${category.cname}</a></li>
                    </c:forEach>
                </ul>
            </div>
        </div>
            ...
            <div style="padding: 30px;">
                <div class="layui-row layui-col-space15">
                    <c:forEach items="${sessionScope.current_product}" var="product">
                        <div class="layui-col-md12" onclick="window.location.href='getproductinfo.action?pid=${product.pid}'">
