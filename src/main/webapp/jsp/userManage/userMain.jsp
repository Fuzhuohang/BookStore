    ...
    <div class="layui-body">
        <div class="layui-form-item" style="margin-top: 10px">
            <div class="layui-inline">
                <input id="user_id" type="text" placeholder="--编号--" class="layui-input" style="width: 100px">
            </div>
            <div class="layui-inline">
                <input id="user_name" type="text" placeholder="--姓名--" class="layui-input" style="width: 100px">
            </div>
            <div class="layui-inline">
            ...
            <div class="layui-inline">
                <input id="authority" type="text" placeholder="--权限--" class="layui-input" style="width: 100px">
            </div>
...
<script>
    layui.use(['jquery', 'table'], function(){
        ...
        table.render({
            ...
            cols:[[
                {field:'user_id', title:'编号', width:'80'},
