...
<div class="layui-layout layui-layout-admin">
    ...
    <div class="layui-body">
        ...
        <form class="layui-form layui-form-pane" lay-falter="updateForm">
            <div class="layui-form-item">
                <div class="layui-inline">
                    ...
                    <div class="layui-input-block">
                        <input type="text" name="talent_name" placeholder="更改姓名" autocomplete="off" class="layui-input" style="width: 200px">
                    </div>
                </div>
            ...
            <div class="layui-form-item">
                <div class="layui-input-block">
                    <button class="layui-btn" lay-submit lay-filter="updateTalSubmit">立即提交</button>
...
<script>
    ...
    layui.use(['form', 'jquery'], function(){
        ...
        form.on('submit(updateTalSubmit)', function(data){
            ...
            $.ajax({
                url: "${pageContext.request.contextPath}/updateTal.action",
                type: "POST",
                data: field,
                dataType: 'JSON',
                cache: false,
