        ...
        <form class="layui-form layui-form-pane">
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input type="text" name="pro_name" required  lay-verify="required" placeholder="请输入姓名" autocomplete="off" class="layui-input" style="width: 200px">
                </div>
            </div>
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input type="date" name="update_time" id="update_time" required  lay-verify="required" autocomplete="off" class="layui-input" style="width: 200px">
                </div>
            </div>
...
<script>
    ...
    layui.use(['form', 'jquery'], function(){
        ...
        form.on('submit(addSubmit)', function(data){
            ...
            $.ajax({
                url: "${pageContext.request.contextPath}/addProEmp.action",
                type: "POST",
                data: field,
                dataType: 'JSON',
                cache: false,
                success:function (data) {
                    if(data.code==0){
                        alert("添加员工信息成功");
                        window.location.href='proMain.jsp';
                    }else{
                        alert(data.msg);
                    }
                },
