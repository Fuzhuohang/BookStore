...
<div class="layui-layout layui-layout-admin">
    ...
    <div class="layui-body">
        ...
        <script>
            document.getElementById("d").innerHTML=" 发生过部门调动的员工信息：";/*写入网页上方大字*/
        </script>
        ...
        <table id="tb_edr" lay-filter="tb_edr">
        </table>
...
<script>
    layui.use(['jquery','table'],function(){
        ...
        //渲染表格
        table.render({
            elem:"#tb_edr",//渲染的表格的id
            url:"${pageContext.request.contextPath}/getDeptRedeployedEList.action",//请求后台的接口
            cols:[[//表头
                ...
                {field: 'deptOrJobNow', title: '当前部门名', width: '120'},
                {field: 'deptOrJobBefore', title: '先前部门名', width: '120'},
                {field: 'reason', title: '部门调动原因', width: '180'}
            ]],
            page:false//是否开启分页
        });
            ...
            $.ajax({
                ...
                , success(res) {
                    ...
                    data.unshift({
                        ...
                        update_time: '入职时间',
                        deptOrJobNow: '现任部门',
                        deptOrJobBefore: '原部门名',
                        reason: '调动原因'
                    });

                    var timestart = Date.now();
                    excel.exportExcel(data, '部门调动员工名单.xlsx', 'xlsx');
